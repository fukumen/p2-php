...
// あぼーん/NG/ハイライトワード登録時に板限定とする（off:0, on:1）
$conf_user_def['expack.spm.ngaborn_bbsonly'] = 0; // (0)
$conf_user_rad['expack.spm.ngaborn_bbsonly'] = array('1' => 'する', '0' => 'しない');
...
$conf_user_rad['expack.editor.savedraft'] = array('1' => 'する', '0' => 'しない');
// 下書きを自動保存するインターバル(秒)
...
$conf_user_rad['expack.editor.mobile.savedraft'] = array('1' => 'する', '0' => 'しない');
// 下書きを自動保存するインターバル(秒)(iphone)
