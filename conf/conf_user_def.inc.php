...
// ("https://menu.5ch.io/bbsmenu.html")                     // 2ch基本

$conf_user_def['brdfile_online'] = "https://menu.5ch.io/bbsmenu.html";
...
// SSL通信で証明書を検証するか ※デバッグ用
$conf_user_def['ssl_verify_peer'] = 1;  // (1)
$conf_user_rad['ssl_verify_peer'] = array('1' => 'する', '0' => 'しない');

// HTTPS接続を使用する
$conf_user_def['use_https'] = 1;  // (1)
$conf_user_rad['use_https'] = array('1' => 'する', '0' => 'しない');

// HTTP接続を使用するドメイン (カンマ区切りで複数指定可)
