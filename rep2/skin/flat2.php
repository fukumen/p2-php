...
$STYLE['sb_th_bgcolor'] = "#FA1A3A"; // ("#d6e7ff") subject テーブルヘッダ背景色
...
$STYLE['sb_tool_bgcolor'] = "#000000"; // ("#8cb5ff") subject ツールバーの背景色
$STYLE['sb_tool_background'] = "./skin/flat/header2.png"; // ("") subject ツールバーの背景画像
$STYLE['sb_tool_border_color'] = "#3E3E3E"; // ("#6393ef") subject ツールバーのボーダー色
$STYLE['sb_tool_color'] = "#FFFFFF"; // ("#d6e7ff") subject ツールバー内 文字色
$STYLE['sb_tool_acolor'] = "#FFFFFF"; // ("#d6e7ff") subject ツールバー内 リンク色
$STYLE['sb_tool_acolor_v'] = "#FFFFFF"; // ("#d6e7ff") subject ツールバー内 訪問済みリンク色
