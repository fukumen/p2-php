...
$STYLE['menu_bgcolor'] = "#fff"; //("#000") メニューの背景色
$STYLE['menu_color'] = "#333"; //("#fff") menu テキスト色
$STYLE['menu_background'] = "./skin/live/bg.gif"; //("") メニューの背景画像
$STYLE['menu_cate_color'] = "#333"; // ("#fff") メニューカテゴリーの色
...
$STYLE['read_bgcolor'] = "#fff; background:url(./skin/live/bg.gif)"; // ("#fff") スレッド表示の背景色
...
$MYSTYLE['base!']['h1#rep2logo span'] = array(
	...
	'border' => "1px solid #999", // ("") 角丸ボックスのボーダー
