...
$STYLE['bgcolor'] = "#f6f6f6"; // ("#fff") 基本 背景色
$STYLE['background'] = ""; // ("./skin/live/bg.gif") 基本 背景画像
...
$STYLE['menu_bgcolor'] = "#f6f6f6"; //("#000") メニューの背景色
$STYLE['menu_color'] = "#333"; //("#fff") menu テキスト色
//$STYLE['menu_background'] = ""; //("") メニューの背景画像
$STYLE['menu_cate_color'] = "#666"; // ("#fff") メニューカテゴリーの色

$STYLE['menu_acolor_h'] = "#900"; // ("#900") メニュー マウスオーバー時のリンク色

$STYLE['menu_ita_color'] = "#333"; // ("#fff") メニュー 板 リンク色
$STYLE['menu_ita_color_v'] = "#333"; // ("#fff") メニュー 板 訪問済みリンク色
...
$STYLE['sb_bgcolor'] = "#f6f6f6"; // ("#fff") subject 背景色
...
$STYLE['sb_th_bgcolor'] = "#f6f6f6"; // ("#fff") subject テーブルヘッダ背景色
$STYLE['sb_th_background'] = "./skin/live/bg.gif"; // ("./skin/live/bg.gif") subject テーブルヘッダ背景画像
$STYLE['sb_tbgcolor'] = "#f6f6f6"; // ("#fff") subject テーブル内背景色0
$STYLE['sb_tbgcolor1'] = "#f6f6f6"; // ("#fff") subject テーブル内背景色1
//$STYLE['sb_tbackground'] = ""; // ("") subject テーブル内背景画像0
//$STYLE['sb_tbackground1'] = ""; // ("") subject テーブル内背景画像1
$STYLE['sb_tbgcolor_nosubject'] = "#dfdfdf"; // ("#dfdfdf") subject テーブル内背景色(subject.txtに無いとき)
...
$STYLE['sb_tool_bgcolor'] = "#f6f6f6"; // ("#000") subject ツールバーの背景色
//$STYLE['sb_tool_background'] = ""; // ("") subject ツールバーの背景画像
$STYLE['sb_tool_border_color'] = "#ccc"; // ("#900") subject ツールバーのボーダー色
$STYLE['sb_tool_color'] = "#666"; // ("#fff") subject ツールバー内 文字色
$STYLE['sb_tool_acolor'] = "#333"; // ("#fff") subject ツールバー内 リンク色
$STYLE['sb_tool_acolor_v'] = "#333"; // ("#fff") subject ツールバー内 訪問済みリンク色
$STYLE['sb_tool_acolor_h'] = "#900"; // ("#900") subject ツールバー内 マウスオーバー時のリンク色
$STYLE['sb_tool_sepa_color'] = "#333"; // ("#fff") subject ツールバー内 セパレータ文字色
...
$STYLE['read_bgcolor'] = "#f6f6f6"; // ("#fff") スレッド表示の背景色
...
$STYLE['respop_b_color'] = "#ccc"; // ("#999") レスポップアップのボーダー色
//$STYLE['respop_b_style'] = "dotted"; // ("double") レスポップアップのボーダー形式
...
$MYSTYLE['read']['form#header']['background'] = "#f6f6f6"; // ("#000") スレッド表示ヘッダの背景
$MYSTYLE['read']['form#header']['border'] = "1px #ccc solid"; // ("1px #900 solid") スレッド表示ヘッダの下ボーダー
$MYSTYLE['read']['form#header']['color'] = "#333"; // ("#fff") スレッド表示ヘッダのテキスト色
...
$MYSTYLE['read']['div#kakiko']['background'] = "#f6f6f6"; // ("#fff url(./skin/live/bg.gif)") スレッド表示 下部レスフォーム部 背景
...
$MYSTYLE['iv2']['div#toolbar']['background'] = "#f6f6f6"; // ("#000") イメージビューワーツールバーの背景
$MYSTYLE['iv2']['div#toolbar td']['color'] = "#333"; // ("#fff") イメージビューワーツールバーのテキスト色

// スレタイの影（たぶんSafariとかOperaぐらいしか対応してない・・・KonquerorでもOK？）
//$MYSTYLE['read']['.thread_title']['text-shadow'] = "5px 5px 20px #666"; // ("5px 5px 20px #666")

//新着レス
$MYSTYLE['subject']['sb_td']['border-top'] = "1px dotted #ccc"; // ("1px dotted #999") subject テーブルのボーダー0
$MYSTYLE['subject']['sb_td1']['border-top'] = "1px dotted #ccc"; // ("1px dotted #999") subject テーブルのボーダー1
$MYSTYLE['subject']['.itatitle']['font-size'] = "10px"; // ("10px") subject 板名

//フィルタリング結果
$MYSTYLE['base']['#filterstart, .filtering']['background-color'] = "transparent"; // ("transparent") フィルタリング背景色
$MYSTYLE['base']['#filterstart, .filtering']['font-family'] = $STYLE['fontfamily']; // ($STYLE['fontfamily']) フィルタリング フォントファミリー
$MYSTYLE['base']['#filterstart, .filtering']['font-weight'] = 'normal'; // ('normal') フィルタリング フォントの太さ
//$MYSTYLE['base']['#filterstart, .filtering']['border-top'] = ""; // ("") フィルタリング ボーダー上
//$MYSTYLE['base']['#filterstart, .filtering']['border-right'] = ""; // ("") フィルタリング ボーダー右
$MYSTYLE['base']['#filterstart, .filtering']['border-bottom'] = "3px #900 double"; // ("3px #900 double") フィルタリング ボーダー下
//$MYSTYLE['base']['#filterstart, .filtering']['border-left'] = ""; // ("") フィルタリング ボーダー左

//HTMLポップアップ
$MYSTYLE['read']['#iframespace']['border'] = "1px #999 solid"; // ("4px #999 double") HTMLポップアップのボーダー
$MYSTYLE['read']['#closebox']['border'] = "1px #999 solid"; // ("4px #999 double") HTMLポップアップ クローズボックスのボーダー
...
$MYSTYLE['read']['div.res-header'] = array(
	'border-bottom' => "1px solid #ccc", // ("") 角丸ボックス内の仕切線
