...
if (!$_conf['ktai']) {
    ...
    <table class="edit_conf_user" cellspacing="0">
        ...
        <tr class="group">
            <td colspan="4">新規登録</td>
        </tr>\n
EOP;
    $row_format = <<<EOP
        <tr>
            <td><input type="checkbox" name="dat[%1\$d][del]" value="1"></td>
            <td><input type="text" size="30" name="dat[%1\$d][title]" value="%2\$s"></td>
            <td><input type="text" size="60" name="dat[%1\$d][match]" value="%3\$s"></td>
            <td><input type="text" size="60" name="dat[%1\$d][replace]" value="%4\$s"></td>
        </tr>\n
EOP;
// 携帯用表示
} else {
    echo "新規登録<br>\n";
    $row_format = <<<EOP
<input type="text" name="dat[%1\$d][title]" value="%2\$s"><br>
<input type="text" name="dat[%1\$d][match]" value="%3\$s"><br>
<input type="text" name="dat[%1\$d][replace]" value="%4\$s"><br>
