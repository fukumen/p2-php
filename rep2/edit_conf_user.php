...
//        array('iframe_popup_delay', 'HTMLポップアップの表示遅延時間 (秒)'),
        ...
        array('coloredid.click', 'IDとワッチョイ出現数をクリックすると着色をトグル(「しない」にするとJavascriptではなくPHPで着色)'),
        array('coloredid.marking.colors', 'IDとワッチョイ出現数をダブルクリックしてマーキングの色リスト(カンマ区切り)'),
        array('coloredid.smartphone.tap', 'スマホでIDとワッチョイ出現数をタップするとマーキングする(「しない」にすると着色をトグル)'),
